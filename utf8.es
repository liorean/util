...
|***************************************************************************|
|*  utf8encode                                                             *|
|*    < StringOrUInt32 unencoded_character                                 *|
...
|*  utf8decode                                                             *|
|*    < uint8 highendbyte                                                  *|
|*    < uint8 highmidendbyte                                               *|
|*    < uint8 lowmidendbyte                                                *|
|*    < uint8 lowendbyte                                                   *|
|*    > uint32 character                                                   *|
|*    | ErrorString                                                        *|
|*                                                                         *|
|*  utf8decode takes up to four arguments of type uint8 representing utf8  *|
|*    code units and returns a uint32 representing that code point.        *|
\***************************************************************************/
